...
[![Coverage status](https://coveralls.io/repos/github/elbersb/segregation/badge.svg)](https://coveralls.io/r/elbersb/segregation?branch=master)
...
- every method returns a [tidy](http://vita.had.co.nz/papers/tidy-data.html) data frame for easy post-processing and plotting
