...
-   calculate total, between, within, and local segregation using the M/H indices
-   decompose differences in total segregation over time (Elbers 2020)
-   other supported indices are the dissimilarity, isolation, and exposure indices
...
and [in this working paper](https://osf.io/preprints/socarxiv/ruw4g/).
