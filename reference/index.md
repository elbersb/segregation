...
- [`mutual_local_expected()`](https://elbersb.com/segregation/reference/mutual_local_expected.md)
  : Calculates expected local segregation scores when true segregation
  is zero
