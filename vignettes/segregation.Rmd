...
```{r}
# setting n_bootstrap = 100 here to speed up - more iterations are recommended in practice
mutual_total(schools00, "race", "school",
  weight = "n",
  se = TRUE, CI = .95, n_bootstrap = 100
)
```
...
```{r}
# setting n_bootstrap = 100 here to speed up
localse <- mutual_local(schools00, "race", "school",
  weight = "n",
  se = TRUE, wide = TRUE, n_bootstrap = 100
)
...
```{r}
# setting n_bootstrap = 100 here to speed up
mutual_expected(schools00, "race", "school", weight = "n", n_bootstrap = 100)
```
