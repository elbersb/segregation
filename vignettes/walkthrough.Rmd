...
To obtain the local segregation scores $L_u$, along with the marginal weights $p_{u\cdot}$, use [mutual_local](https://elbersb.github.io/segregation/reference/mutual_local.html):
